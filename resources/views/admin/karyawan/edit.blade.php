...
@section('sidebar-menu')
    ...
    <a href="{{ route('admin.karyawan.index') }}" class="flex items-center gap-3 px-2 py-2 rounded-lg bg-green-50 text-green-700 font-medium text-sm mb-1">
...
<div class="max-w-2xl">
    <div class="bg-white rounded-2xl border border-gray-100 p-6">
        <div class="flex items-center gap-4 mb-6">
            <img src="https://ui-avatars.com/api/?name={{ $karyawan->name }}&background=6366f1&color=fff&size=64"
        ...
        <form method="POST" action="{{ route('admin.karyawan.update', $karyawan) }}">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    <label class="text-xs text-gray-400 mb-1 block">Password baru <span class="text-gray-300">(kosongkan jika tidak diubah)</span></label>
