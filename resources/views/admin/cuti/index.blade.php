...
@section('sidebar-menu')
    ...
    <a href="{{ route('admin.cuti.index') }}" class="flex items-center gap-3 px-2 py-2 rounded-lg bg-green-50 text-green-700 font-medium text-sm mb-1">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            <img src="https://ui-avatars.com/api/?name={{ $cuti->user->name }}&background=6366f1&color=fff" class="w-9 h-9 rounded-full flex-shrink-0">
                            <div>
